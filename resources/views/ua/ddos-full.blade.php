...
@section('content')
    ...
    <div class="spoiler">
        ...
        <div>
            ...
            <h4>Простий рівень <em>(середня ефективність)</em></h4>
            <p>Після ввімкнення VPN наші інструменти до ваших послуг:</p>
            <h5>Програми (рекомендований шлях)</h5>
            <ol>
                <li>
                    <p>
            ...
            <h5>Сайти (якщо немає комп'ютера щоб запустити програми)</h5>
            <ol>
                <li>
                    <p>
