...
@section('content')
    ...
    <div class="spoiler">
        ...
        <label for="other-attack-levels">
            <h5><i class="bi bi-caret-right-square"></i> <span class="link-primary text-decoration-underline">Простий та досвічений рівні - натисни сюди</span> <i class="bi bi-caret-left-square"></i></h5>
        </label>
        <div>
            <p>
            ...
            <p>
                Інші варіанти:
                <ul>
                    <li><a href="https://arriven.github.io/db1000n/uk/#як-обрати-vpn">Перелік безплатних VPN-сервісів для українців</a></li>
                ...
                Особисто я використовую <a href="https://www.cyberghostvpn.com/">CyberGhost VPN</a> (платний, проте добре працює, є багато країн).
            </p>
            ...
            <ol>
                ...
                <li>
                    <p>
                        ...
                        Атакує стандартний перелік російських сайтів. <a href="https://t.me/ddos_for_all/80?comment=931">Щодо ефективності є сумніви</a>.<br />
                        <span class="text-danger">Увага!</span> Після відкриття цього сайту ваш ноутбук, або комп'ютер може виснути, будьте обережні.<br />
                        <span class="text-warning">Важливо!</span> Не забувайте про увімкнений VPN, який потрібно час від часу змінювати, або Tor Browser, у який потрібно час від часу перезаходити!
                    </p>
                </li>
