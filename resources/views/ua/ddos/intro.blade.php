...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                Всі інструменти для атаки <b>перевірені близько 60 антивірусами</b> (через VirusTotal).
                Звичайно також ти їх можеш перевірити власноруч будь-яким антивірусом; твоє місцезнаходження буде приховано (за допомогою VPN або вбудованого в програму проксі).
            </p>
